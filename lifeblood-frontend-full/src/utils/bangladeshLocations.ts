...
// Source: nuhil/bangladesh-geocode (https://github.com/nuhil/bangladesh-geocode),
// district/upazila names aligned to this app's existing spellings so search/match
// strings stay consistent with already-registered users.
...
export const upazilasByDistrict: Record<string, string[]> = {
  ...
  "Chittagong": ["Anwara", "Banshkhali", "Boalkhali", "Chandanaish", "Fatikchhari", "Hathazari", "Karnafuli", "Lohagara", "Mirsharai", "Patiya", "Rangunia", "Raozan", "Sandwip", "Satkania", "Sitakunda"],
  ...
  "Nawabganj": ["Bholahat", "Chapainawabganj Sadar", "Gomostapur", "Nachol", "Shibganj"],
  ...
  "Jessore": ["Abhaynagar", "Bagherpara", "Chougachha", "Jessore Sadar", "Jhikargacha", "Keshabpur", "Manirampur", "Sharsha"],
